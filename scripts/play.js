...
function explainTheGame() {
  ...
  document.getElementById("showBox").innerHTML =
    "Let's shuffle!<br>" +
    "Press the Shuffle the Deck button to shuffle.<br>" +
    "Then make your bets.<br>" +
    "Press Deal to deal a hand.";
}
...
function createShoe() {
  ...
  function burnCards() {
    ...
    document.getElementById("showBox").innerHTML =
      "The deck is shuffled. We are ready to play.";
  }
}
...
function seeIfThereIsEnoughMoney() {
  if (myRunningChipTotal <= 0) {
    ...
    document.getElementById("showBox").innerHTML =
      "You have run out of money. Please restart the game.";
    stopTheGame();
  }
...
function seeIfThereAreEnoughCards() {
  if (theShoe.length < 52) {
    ...
    document.getElementById("showBox").innerHTML =
      "The cut card is out. Please reshuffle.";
    stopTheGame();
  }
  console.log(
    "-------------------Hand",
