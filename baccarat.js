// showBox에 들어갈 내용 추가
// ctrl + f showBow 찾기
// document.getElementById("showBox").innerHTML  찾기
...
function explainTheGame() {
  ...
  document.getElementById("showBox").innerHTML = "Let's shuffle!<br>" + "Press the Shuffle the Deck button to shuffle.<br>" + "Then make your bets.<br>" + "Press Deal to deal a hand.";
...
function createShoe() {
  ...
  function burnCards() {
    ...
    document.getElementById("showBox").innerHTML = ("The deck is shuffled. We are ready to play.");
...
function updateRunningChipTotal() {
  ...
  if (resultIsAPanda === true) {
    ...
    if (playerBet) {
      ...
      document.getElementById("showBox").innerHTML = "The PLAYER wins with "+
      playerTotal+
      " points against the banker's "+
      bankerTotal+
      ".<br> You win " +
      ...
      document.getElementById("showBox").innerHTML =" Sorry, the PLAYER wins with "+
        playerTotal+
        " points against the banker's "+
        bankerTotal+
        ".<br>You lose "+
    ...
    tieBet_1 = tieBet * 8 ;
    document.getElementById("showBox").innerHTML = ("You win " + tieBet_1 +  " dollars.\n "+" The banker and player push on a tie.");
  }
...
function seeIfThereIsEnoughMoney() {
  if (myRunningChipTotal <= 0) {
    ...
    document.getElementById("showBox").innerHTML = "You have run out of money. Please restart the game.";
    stopTheGame();
  }
...
function seeIfThereAreEnoughCards() {
  if (theShoe.length < 52) {
    ...
    document.getElementById("showBox").innerHTML = "The cut card is out. Please reshuffle.";
    stopTheGame();
